...
public class TileEntities {
    ...
    public static void init() {
        wind_mill_entity_type = reignitedutilites.TILE_ENTITIES.register("wind_mill", () -> TileEntityType.Builder.of(WindMillTile::new, Blocks.WIND_MILL.get()).build(null));
        ...
        manual_mill_entity_type = reignitedutilites.TILE_ENTITIES.register("manual_mill", () -> TileEntityType.Builder.of(ManualMillTile::new, Blocks.MANUAL_MILL.get()).build(null));
        ...
        chunk_loading_ward_entity_type = reignitedutilites.TILE_ENTITIES.register("chunk_loading_ward", () -> TileEntityType.Builder.of(ChunkLoadingWardTile::new, Blocks.CHUNK_LOADING_WARD.get()).build(null));
    }
}
