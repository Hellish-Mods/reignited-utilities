	...
	protected void buildShapelessRecipes(Consumer<IFinishedRecipe> consumer) {
        Blocks.CompressedBlocks.forEach(obj -> {
            ...
            ShapedRecipeBuilder
                ...
                .pattern("BBB")
                .pattern("BBB")
                .define('B', (b.compTier>1 ? ForgeRegistries.ITEMS.getValue(new ResourceLocation(reignitedutilities.MOD_ID, Integer.toString(b.compTier-1)+"_compressed_"+b.mat)) : ForgeRegistries.ITEMS.getValue(new ResourceLocation("minecraft", b.mat))))
