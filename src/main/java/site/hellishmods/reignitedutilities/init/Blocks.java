...
public class Blocks {
    ...
    public static final RegistryObject<Block> SOLAR_PANEL = reignitedutilities.BLOCKS.register("solar_panel", () -> new PanelBlock<SolarPanelMillTile>(TileEntities.solar_panel_mill_entity_type));
    public static final RegistryObject<Block> LUNAR_PANEL = reignitedutilities.BLOCKS.register("lunar_panel", () -> new PanelBlock<LunarPanelMillTile>(TileEntities.lunar_panel_mill_entity_type));
